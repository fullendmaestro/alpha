...
export const inputStatusOutlineClassMap = {
  ...
  default:
    'focus-within:ring-accent-green-200 focus-within:hover:ring-accent-green-200 focus-within:ring-1 hover:ring-secondary-400 hover:ring-1 data-[disabled=true]:ring-0',
} as const
  ...
  ({ className, trailingElement, status, inputClassName, ...props }, ref) => {
    return (
      <div
        ...
        className={cn(
          'flex items-center h-12 gap-2 w-full rounded-xl px-5 text-md font-medium shadow-sm transition-shadow disabled:cursor-not-allowed disabled:opacity-50 md:text-sm outline outline-0 bg-secondary-200 placeholder:text-muted-foreground caret-green-200',
