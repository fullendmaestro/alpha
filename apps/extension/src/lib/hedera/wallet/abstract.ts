...
// index:
// < 0 => alternative derivations or forms (mnemonics have tons of these)
// = 0 => canonical derivation of a key from the wallet
...
export abstract class Wallet {
  ...
  /** Get the private key associated with the wallet (if available) */
